...
import DemoPage from "@/images/landingPage/demo.png"
  ...
  return (
    <main className="">
      <div className="relative isolate pt-14 dark:bg-gray-900">
        ...
        >
          <div
            className='relative left-[calc(50%-11rem)] aspect-[1155/678] w-[34.125rem]
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              <h1 className="text-4xl font-bold tracking-tight sm:text-6xl">
                Chat from Anywhere, With Anyone!
              </h1>
              <p className="mt-6 text-lg loading-8 text-gray-600 dark:text-gray-300">
            ...
            <div className="mt-16 flex-root sm:mt-24">
        ...
        >
          <div
            className='relative left-[calc(50%+3rem)] aspect-[1155/678] w-[34.125rem]
